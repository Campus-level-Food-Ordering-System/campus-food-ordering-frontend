  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="auth-form">
        ...
        <div className="form-group animate-fade-in-3">
        ...
        <div className="form-group animate-fade-in-4">
      ...
      <div className="auth-footer">
        Already have an account? <button onClick={() => navigate('/signin')} className="link-btn">Sign In</button>
      </div>
    </AuthLayout>
  );
}